...
window.addEventListener("resize", centerHMD);
centerHMD();
...
function checkIT() {
  ...
  if (
    geofs.aircraft.instance.id == 4172 ||
    geofs.aircraft.instance.id == 2857 ||
    geofs.aircraft.instance.id == 7 ||
    (geofs.aircraft.instance.id == 18 && geofs.addonAircraft.isFA18 == 1)
  ) {
    if (hmdIsActive == 0) {
